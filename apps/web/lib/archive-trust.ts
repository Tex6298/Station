  ...
  return [
    {
      ...
      result: "Previews format and counts first; confirmation creates a private chat import job and archive chunks for this persona.",
    ...
    },
    {
      ...
      result: "Previews the local file first; confirmation preserves it as private archive chunks after file processing.",
    ...
    },
    {
      ...
      result: "Previews role-labelled turn counts before confirmation parses private archive chunks.",
    ...
    },
    {
      ...
      result: "Previews chronological turn counts before confirmation parses private archive chunks.",
      review: "Memory and Canon candidates stay pending for owner review.",
    ...
    },
    {
      ...
      result: "Previews post/comment counts before confirmation parses private archive chunks.",
      review: "Memory and Canon candidates stay pending for owner review.",
    ...
    },
    {
      ...
      result: "Previews message counts before confirmation parses private archive chunks.",
      review: "Memory and Canon candidates stay pending for owner review.",
    ...
    },
    {
      ...
      result: "Previews known role/content counts before confirmation parses private archive chunks.",
