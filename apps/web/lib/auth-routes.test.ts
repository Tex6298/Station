...
test("auth route guard protects private app routes and preserves public reads", () => {
  const protectedPaths = [
    ...
    "/institutions",
    "/institutions/admin",
    "/institutions/station-labs/team",
    "/institutions/station-labs/space",
    "/institutions/station-labs/community",
    "/institutions/station-labs/activity",
    "/institutions/station-labs/publications/field-note",
    "/space",
    "/space/new",
  ...
  const publicPaths = [
    ...
    "/institutions/station-labs",
    "/institutions/station-labs/publications/public/field-note",
    "/login",
    "/signup",
  ];
