...
- Keep the useful Developer Spaces observatory idea, but keep it Station-native.
- Keep provenance, public/private split, and owner-safe export thinking.
- Keep continuity, publishing, archive, community, and Developer Spaces as the
  near-term product center.

## Rejected carry-forward

Do not import IntelHub CTI, finance, exposure, recon, dark-provider,
browser-worker, PM, or model-gateway modules into Station's current roadmap.
