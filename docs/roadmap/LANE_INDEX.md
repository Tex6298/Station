...
| --- | --- | --- | --- | --- |
| PR472 | Persona Encounter Consent / Provenance Preflight | ARGUS / A3 | Open; smallest unblock preflight for actual encounter runtime | `docs/roadmap/PR472_PERSONA_ENCOUNTER_CONSENT_PROVENANCE_PREFLIGHT_ARGUS.md` |
